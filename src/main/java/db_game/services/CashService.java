...
public class CashService {
    ...
    public void addCash(Long dollarsEarned){
        Optional<Cash> cash = cashRepo.findById(1L);
        Long currentCash = cash.get().getAmountOfCash();
        cash.get().setAmountOfCash(currentCash + dollarsEarned);
    }
